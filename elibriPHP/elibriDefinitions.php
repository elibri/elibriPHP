...
class ElibriDictLanguageCode extends  ElibriDictElement {
  ...
  protected function __construct() {
      parent::__construct(array(
          ...
          new ElibriDictAtom('bat', array('pl' => 'języki bałtyckie', 'en' => 'Baltic languages'), NULL),
          ...
          new ElibriDictAtom('dut', array('pl' => 'holenderski', 'en' => 'Dutch'), NULL),
          ...
          new ElibriDictAtom('gem', array('pl' => 'języki germańskie', 'en' => 'Germanic languages'), NULL),
          ...
          new ElibriDictAtom('mul', array('pl' => 'wiele języków', 'en' => 'Multiple languages'), NULL),
